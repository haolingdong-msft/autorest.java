...
/** Initializes a new instance of the asynchronous UploadSpecialFilesClient type. */
@ServiceClient(builder = UploadSpecialFilesClientBuilder.class, isAsync = true)
public final class UploadSpecialFilesAsyncClient {

    @Generated private final UploadSpecialFilesClientImpl serviceClient;

    /**
     * Initializes an instance of UploadSpecialFilesAsyncClient class.
     *
     * @param serviceClient the service client implementation.
     */
    @Generated
    UploadSpecialFilesAsyncClient(UploadSpecialFilesClientImpl serviceClient) {
