...
/** Initializes a new instance of the ClassificationSchemaClient type. */
public final class ClassificationSchemaClientImpl {
    /** The proxy service used to perform REST calls. */
    private final ClassificationSchemaClientService service;
    ...
    /**
     * Initializes an instance of ClassificationSchemaClient client.
     *
     * @param endpoint Server parameter.
     * @param serviceVersion Service version.
     */
    public ClassificationSchemaClientImpl(String endpoint, DataManagementServiceVersion serviceVersion) {
        this(
     ...
     * @param serviceVersion Service version.
     */
    public ClassificationSchemaClientImpl(
    ...
    public ClassificationSchemaClientImpl(
        ...
        this.service =
                RestProxy.create(
                        ClassificationSchemaClientService.class, this.httpPipeline, this.getSerializerAdapter());
    }

    /**
     * The interface defining all the services for ClassificationSchemaClient to be used by the proxy service to perform
     * REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "ClassificationSchema")
    public interface ClassificationSchemaClientService {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<LongRunningOperation, Object> beginCreateWithModelAsync(RequestOptions requestOptions) {
        return PollerFlux.create(
                Duration.ofSeconds(1),
                () -> this.createWithResponseAsync(requestOptions),
                new DefaultPollingStrategy<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<LongRunningOperation, Object> beginCreateWithModel(RequestOptions requestOptions) {
     ...
     */
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<LongRunningOperation, Void> beginDeleteWithModel(String name, RequestOptions requestOptions) {
