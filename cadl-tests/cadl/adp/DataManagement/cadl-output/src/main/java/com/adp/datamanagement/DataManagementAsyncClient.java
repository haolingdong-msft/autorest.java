...
public final class DataManagementAsyncClient {
    ...
    public Mono<Response<BinaryData>> getLongRunningWithResponse(String operationId, RequestOptions requestOptions) {
        return this.serviceClient.getLongRunningWithResponseAsync(operationId, requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<LongRunningOperation> getLongRunning(String operationId) {
        // Generated convenience method for getLongRunningWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getLongRunningWithResponse(operationId, requestOptions)
