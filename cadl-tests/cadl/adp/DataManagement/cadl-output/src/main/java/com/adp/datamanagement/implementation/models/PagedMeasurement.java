...
@Immutable
public final class PagedMeasurement {
    /*
    ...
    /**
     * Creates an instance of PagedMeasurement class.
     *
     * @param value the value value to set.
     */
    @JsonCreator
    private PagedMeasurement(@JsonProperty(value = "value", required = true) List<Measurement> value) {
        this.value = value;
    }

    /**
     * Get the value property: The Measurement items on this page.
     *
