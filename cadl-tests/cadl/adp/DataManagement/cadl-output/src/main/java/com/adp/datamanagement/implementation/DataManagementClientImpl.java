...
public final class DataManagementClientImpl {
    ...
    public interface DataManagementClientService {
        ...
        @Post("/uploads/{uploadId}/specialFilesUploadInfo:listWritableUris")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(
                value = ClientAuthenticationException.class,
                code = {401})
        ...
        @Post("/uploads/{uploadId}/dataFilesUploadInfo:generate")
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(
                value = ClientAuthenticationException.class,
                code = {401})
        ...
        @Post("/uploads/{uploadId}/dataFilesUploadInfo:listWritableUris")
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(
                value = ClientAuthenticationException.class,
                code = {401})
    ...
    public SyncPoller<LongRunningOperation, Object> beginGenerateWithModel(
            String uploadId, RequestOptions requestOptions) {
        return this.beginGenerateWithModelAsync(uploadId, requestOptions).getSyncPoller();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<BinaryData> listWritableUrisAsync(String uploadId, RequestOptions requestOptions) {
        RequestOptions requestOptionsForNextPage = new RequestOptions();
        requestOptionsForNextPage.setContext(
                requestOptions != null && requestOptions.getContext() != null
                        ? requestOptions.getContext()
                        : Context.NONE);
        return new PagedFlux<>(
                () -> listWritableUrisSinglePageAsync(uploadId, requestOptions),
                nextLink -> listWritableUrisNextSinglePageAsync(nextLink, requestOptionsForNextPage));
    }
    ...
    public PagedIterable<BinaryData> listWritableUris(String uploadId, RequestOptions requestOptions) {
        return new PagedIterable<>(listWritableUrisAsync(uploadId, requestOptions));
    }
