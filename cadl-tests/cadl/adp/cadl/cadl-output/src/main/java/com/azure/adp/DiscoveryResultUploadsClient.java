...
@ServiceClient(builder = DiscoveryResultUploadsClientBuilder.class)
public final class DiscoveryResultUploadsClient {
    @Generated private final DiscoveryResultUploadsAsyncClient client;

    /**
     * Initializes an instance of DiscoveryResultUploadsClient class.
     *
     * @param client the async client.
     */
    @Generated
    DiscoveryResultUploadsClient(DiscoveryResultUploadsAsyncClient client) {
        this.client = client;
    }
