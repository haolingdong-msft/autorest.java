...
import com.azure.adp.implementation.UploadSpecialFilesImpl;
...
public final class UploadSpecialFilesAsyncClient {
    @Generated private final UploadSpecialFilesImpl serviceClient;
     ...
     */
    @Generated
    UploadSpecialFilesAsyncClient(UploadSpecialFilesImpl serviceClient) {
    ...
    public PagedFlux<UploadSpecialFile> list(String uploadId) {
        ...
        return list(uploadId, requestOptions)
                .mapPage(protocolMethodData -> protocolMethodData.toObject(UploadSpecialFile.class));
    }
}
