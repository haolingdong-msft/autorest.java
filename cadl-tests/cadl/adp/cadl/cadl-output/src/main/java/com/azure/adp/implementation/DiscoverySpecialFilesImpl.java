...
/** An instance of this class provides access to all the operations defined in DiscoverySpecialFiles. */
public final class DiscoverySpecialFilesImpl {
    /** The proxy service used to perform REST calls. */
    private final DiscoverySpecialFilesService service;

    /** The service client containing this operation class. */
    private final AutonomousDevelopmentPlatformClientImpl client;

    /**
     * Initializes an instance of DiscoverySpecialFilesImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    DiscoverySpecialFilesImpl(AutonomousDevelopmentPlatformClientImpl client) {
        this.service =
                RestProxy.create(
                        DiscoverySpecialFilesService.class, client.getHttpPipeline(), client.getSerializerAdapter());
        this.client = client;
    }

    /**
     * The interface defining all the services for AutonomousDevelopmentPlatformDiscoverySpecialFiles to be used by the
     * proxy service to perform REST calls.
     */
    @Host("{endpoint}")
    @ServiceInterface(name = "AutonomousDevelopmen")
    private interface DiscoverySpecialFilesService {
        @Get("/discoveries/{discoveryId}/specialFilesUploadInfo")
