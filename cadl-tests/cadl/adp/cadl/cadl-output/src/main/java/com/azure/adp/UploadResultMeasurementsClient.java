...
@ServiceClient(builder = UploadResultMeasurementsClientBuilder.class)
public final class UploadResultMeasurementsClient {
    @Generated private final UploadResultMeasurementsAsyncClient client;

    /**
     * Initializes an instance of UploadResultMeasurementsClient class.
     *
     * @param client the async client.
     */
    @Generated
    UploadResultMeasurementsClient(UploadResultMeasurementsAsyncClient client) {
        this.client = client;
    }
